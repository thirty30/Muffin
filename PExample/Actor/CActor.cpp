...
CCubeActor::CCubeActor() : CPhysicsObject(this), CGraphicsObject(this)
{
...
void CCubeActor::OnCollision(SCollisionInfo& a_rCollision)
{
	this->pTempParticle->m_vPosition = this->m_vPosition;
	this->pTempParticle->m_bEnable = true;
}
